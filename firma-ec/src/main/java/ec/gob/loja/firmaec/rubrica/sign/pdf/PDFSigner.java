 ...
 */
package ec.gob.loja.firmaec.rubrica.sign.pdf;
...
import ec.gob.loja.firmaec.rubrica.exceptions.RubricaException;
import ec.gob.loja.firmaec.rubrica.exceptions.InvalidFormatException;
...
import ec.gob.loja.firmaec.rubrica.utils.BouncyCastleUtils;
import ec.gob.loja.firmaec.rubrica.utils.FileUtils;
import ec.gob.loja.firmaec.rubrica.utils.Utils;

import ec.gob.loja.firmaec.rubrica.utils.PropertiesUtils;
import ec.gob.loja.firmaec.rubrica.utils.QRCode;
...
public class PDFSigner implements Signer {
    ...
    public byte[] sign(byte[] data, String algorithm, PrivateKey key, Certificate[] certChain, Properties xParams)
        ...
        try {
            ...
            throw new RubricaException(PropertiesUtils.getMessages().getProperty("mensaje.error.driver_problemas") + "\n", ec);
