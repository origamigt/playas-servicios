 ...
 */
package ec.gob.loja.firmaec.rubrica.certificate.ec.securitydata;

import static ec.gob.loja.firmaec.rubrica.certificate.ec.securitydata.CertificadoSecurityData.OID_CEDULA_PASAPORTE;
import static ec.gob.loja.firmaec.rubrica.certificate.ec.securitydata.CertificadoSecurityData.OID_TIPO_FUNCIONARIO_PUBLICO;
import static ec.gob.loja.firmaec.rubrica.certificate.ec.securitydata.CertificadoSecurityData.OID_TIPO_MIEMBRO_EMPRESA;
import static ec.gob.loja.firmaec.rubrica.certificate.ec.securitydata.CertificadoSecurityData.OID_TIPO_PERSONA_JURIDICA_EMPRESA;
import static ec.gob.loja.firmaec.rubrica.certificate.ec.securitydata.CertificadoSecurityData.OID_TIPO_PERSONA_NATURAL;
import static ec.gob.loja.firmaec.rubrica.certificate.ec.securitydata.CertificadoSecurityData.OID_TIPO_PERSONA_NATURAL_PROFESIONAL;
import static ec.gob.loja.firmaec.rubrica.certificate.ec.securitydata.CertificadoSecurityData.OID_TIPO_PRUEBA;
import static ec.gob.loja.firmaec.rubrica.certificate.ec.securitydata.CertificadoSecurityData.OID_TIPO_REPRESENTANTE_LEGAL;
import static ec.gob.loja.firmaec.rubrica.utils.BouncyCastleUtils.certificateHasPolicy;
