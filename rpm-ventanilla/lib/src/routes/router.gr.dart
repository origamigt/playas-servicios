...
import 'guard_router.dart' as _i28;
...
class AppRouter extends _i26.RootStackRouter {
  ...
  List<_i26.RouteConfig> get routes => [
        ...
        _i26.RouteConfig(CertificadoWebRoute.name, path: '/validarCertificado'),
        _i26.RouteConfig(TramitesRoute.name,
            path: '/tramites', guards: [authGuard]),
        _i26.RouteConfig(NoposeerBienRoute.name,
            path: '/noposeerbien', guards: [authGuard]),
        _i26.RouteConfig(AjustesRoute.name,
            path: '/ajustes', guards: [authGuard]),
        _i26.RouteConfig(PerfilRoute.name,
            path: '/perfil', guards: [authGuard]),
        _i26.RouteConfig(ContraseniaRoute.name,
            path: '/actualizarContrasenia', guards: [authGuard]),
        _i26.RouteConfig(PagoRoute.name,
            path: '/pagos/procesar', guards: [authGuard]),
        _i26.RouteConfig(PropiedadRoute.name,
            path: '/propiedad', guards: [authGuard]),
        _i26.RouteConfig(InscripcionesRoute.name,
            path: '/inscripciones', guards: [authGuard]),
        _i26.RouteConfig(PersonalRoute.name,
            path: '/fichaPersonal', guards: [authGuard]),
        _i26.RouteConfig(MercantilRoute.name,
            path: '/mercantil', guards: [authGuard]),
        _i26.RouteConfig(PagoInscripcionRoute.name,
            path: '/inscripciones/pagoInscripcion', guards: [authGuard]),
        _i26.RouteConfig(CarpetaCiudadanaRoute.name,
            path: '/carpetaCiudadana', guards: [authGuard]),
        _i26.RouteConfig(MisTramitesRoute.name,
            path: '/misTramites', guards: [authGuard]),
        _i26.RouteConfig(BuscarRoute.name,
            path: '/consultarTramite', guards: [authGuard]),
        _i26.RouteConfig(RepositorioRoute.name,
            path: '/misDocumentos', guards: [authGuard]),
        _i26.RouteConfig(NosotrosRoute.name,
...
class RegistrarseRoute extends _i26.PageRouteInfo<void> {
...
class RecuperarRoute extends _i26.PageRouteInfo<void> {
...
class EntidadRoute extends _i26.PageRouteInfo<void> {
...
class VerificarDocRoute extends _i26.PageRouteInfo<void> {
...
class CertificadoMovRoute extends _i26.PageRouteInfo<void> {
...
class CertificadoWebRoute extends _i26.PageRouteInfo<void> {
...
class TramitesRoute extends _i26.PageRouteInfo<void> {
...
class NoposeerBienRoute extends _i26.PageRouteInfo<void> {
...
class AjustesRoute extends _i26.PageRouteInfo<void> {
...
class PerfilRoute extends _i26.PageRouteInfo<void> {
...
class ContraseniaRoute extends _i26.PageRouteInfo<void> {
...
class PagoRoute extends _i26.PageRouteInfo<PagoRouteArgs> {
...
class PropiedadRoute extends _i26.PageRouteInfo<void> {
...
class InscripcionesRoute extends _i26.PageRouteInfo<void> {
...
class PersonalRoute extends _i26.PageRouteInfo<void> {
...
class MercantilRoute extends _i26.PageRouteInfo<void> {
...
class PagoInscripcionRoute extends _i26.PageRouteInfo<void> {
...
class CarpetaCiudadanaRoute extends _i26.PageRouteInfo<void> {
...
class MisTramitesRoute extends _i26.PageRouteInfo<void> {
...
class BuscarRoute extends _i26.PageRouteInfo<void> {
...
class RepositorioRoute extends _i26.PageRouteInfo<void> {
...
class NosotrosRoute extends _i26.PageRouteInfo<void> {
